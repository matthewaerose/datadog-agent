...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/flare/builder v0.77.2
	...
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.77.2
	...
	github.com/DataDog/datadog-agent/pkg/config/env v0.77.2
	...
	github.com/DataDog/datadog-agent/pkg/config/structure v0.77.2
	github.com/DataDog/datadog-agent/pkg/config/utils v0.77.2
	...
	github.com/DataDog/datadog-agent/pkg/logs/status/utils v0.77.2
	github.com/DataDog/datadog-agent/pkg/logs/types v0.77.2
	...
	github.com/DataDog/datadog-agent/pkg/util/executable v0.77.2
	...
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.77.2
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/logs/processor v0.77.2
