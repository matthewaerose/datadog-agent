...
import (
	...
	npcollectorimpl "github.com/DataDog/datadog-agent/comp/networkpath/npcollector/npcollectorimpl"
...
func TestConnectionsCheckDisabledOnDarwin(t *testing.T) {
	...
	c := fxutil.Test[connectionscheck.Component](t, fx.Options(
		...
		fxutil.Component(fxutil.ProvideComponentConstructor(NewCheck)),
	))
