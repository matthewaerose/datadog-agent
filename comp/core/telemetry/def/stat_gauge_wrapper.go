...
func NewStatGaugeWrapper(component Component, subsystem, name string, tags []string, description string) *StatGaugeWrapper {
	return &StatGaugeWrapper{
		gauge: component.NewGauge(subsystem, name, tags, description),
	}
}
